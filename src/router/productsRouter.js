...
router.post("/create-product",  upload.array("images"), transformFilesToBody, bodyValidation(createProductsSchema), isProductAlreadyExists,isCategoryExistByCategory, productController.adminCreateProduct)
