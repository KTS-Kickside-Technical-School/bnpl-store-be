...
import { hashPassword, generateToken } from "../../../helpers/authHelpers.js";
...
const registerUser = async (req, res) => {
  try {
    ...
    await sendEmail(
      ...
      `Your registration was successful. Click this link to verify your account: ${process.env.FRONTEND_URL}/api/v1/auth/verify/${token}`
    );
